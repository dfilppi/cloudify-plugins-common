...
class NonRecoverableError(Exception):
    ...
    def __init__(self, *args, **kwargs):
        self.causes = kwargs.pop('causes', None)
...
class RecoverableError(Exception):
    ...
    def __init__(self, message=None, retry_after=None, causes=None):
        message = message or ''
...
class HttpException(NonRecoverableError):
    ...
    def __init__(self, url, code, message, causes=None):
        self.url = url
        self.code = code
        self.message = message
        super(HttpException, self).__init__(str(self), causes=causes)
